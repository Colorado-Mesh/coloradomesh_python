...
from coloradomesh.meshcore.standards import (
    COLORADOMESH_MQTT_HOST,
    COLORADOMESH_MQTT_PORT,
    COLORADOMESH_MQTT_AUDIENCE
)


class ColoradoMeshMQTTBroker(MQTTBroker):
    def __init__(
            self,
            client_name: str,
            public_key: str,
        ...
        super().__init__(
            ...
            broker_name="ColoradoMesh",
            broker_host=COLORADOMESH_MQTT_HOST,
            broker_port=COLORADOMESH_MQTT_PORT,
            use_tls=True,
            use_websockets=True,
            auth=TokenBasedMQTTBrokerAuth(
                public_key=public_key,
                private_key_hex=private_key_hex,
                audience=COLORADOMESH_MQTT_AUDIENCE,
