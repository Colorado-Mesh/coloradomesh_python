...
def determine_region_by_latitude_and_longitude(latitude: Optional[float], longitude: Optional[float]) -> Optional[Regions]:
    ...
    for region in Regions:
        ...
        distance = GD((latitude, longitude), airport_location).km
...
class NodeRegionMapEntry:
    def __init__(self, node: Node, region: Optional[Regions]):
        self.node: Node = node
        self.region: Optional[Regions] = region
