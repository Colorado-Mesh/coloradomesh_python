...
from coloradomesh.meshtastic.services.mqtt._base import (
    ...
    MeshtasticMQTTNodeInfoMessage,
    MeshtasticMQTTPositionMessage,
    MeshtasticMQTTRoutingMessage,
    MeshtasticMQTTTelemetryMessage,
    MeshtasticMQTTTextMessage,
)
...
class MeshtasticMQTTBroker(MQTTBroker):
    def __init__(self,
                 ...
                 on_reply_callback: Optional[Callable[[MeshtasticMQTTTextMessage], None]] = None,
