...
__title__ = "denvermesh_py"
__author__ = 'Nate Harris'
__author_email__ = 'nwithan8@users.noreply.github.com'
__github_username__ = "nwithan8"
__github_repo__ = "denvermesh_python"
__copyright__ = "Copyright © YEARADDEDBYGITHUB - Nate Harris"
__license__ = 'GNU General Public License v3 (GPLv3)'
__description__ = "A utility package for DenverMesh-related projects",
__keywords__ = ["Denver", "Colorado", "Mesh", "Meshtastic", "MeshCore"]
...
def __supported_python_versions__() -> List[str]:
    ...
    with open(os.path.join(os.path.dirname(__file__), "denvermesh", "PYTHON_VERSIONS.json")) as f:
        versions = f.read()
